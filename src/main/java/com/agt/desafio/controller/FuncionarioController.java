...
public class FuncionarioController {
    ...
    @PostMapping
    public ResponseEntity<Funcionario> create(@Valid @RequestBody CriarFuncionarioDTO dto) {
    ...
    @PatchMapping("/{id}")
    public ResponseEntity<Funcionario> patch(@PathVariable("id") Long id, @RequestBody CriarFuncionarioDTO dto) {
